...
// to that member and 0.5 to whoever created the application. Otherwise the
// full credit goes to the demat holder, as before. Summing into a
// name-keyed map is what makes the "same person on both sides" and "fully
// self-service member" cases collapse to a plain 1 with no special-casing.
