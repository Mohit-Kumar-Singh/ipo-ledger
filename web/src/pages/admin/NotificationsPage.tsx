...
export function NotificationsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Non-admin sees this too, not just admin — a funder's own "this IPO
          is allotted, funded by you" card, same underlying data (RLS
          already scopes it to just their own applications), just no Send
          button (nothing to send to themselves) — the expected-profit
          number is shown directly instead, since that's the actual thing
          they're here to see: what they should expect back on their own
          money. v1.170.0 briefly hid this (funder sees status only, not
          the payout math) — reinstated on request; a funder wanting to see
          their own expected return on their own money is a reasonable
          thing to show them, not something that needs hiding. */}
