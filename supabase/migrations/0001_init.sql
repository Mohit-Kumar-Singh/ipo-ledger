...
-- auto-create a profile row when a new auth user signs up (defaults to member)
...
create table demat_accounts (
  ...
  pan_encrypted   bytea not null,                        -- pgp_sym_encrypt(pan, key) — set by add-demat Edge Function
